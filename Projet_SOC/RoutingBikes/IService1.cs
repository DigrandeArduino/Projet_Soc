...
namespace RoutingBikes
{
    ...
    public class Finder
    {
        ...
        private void SetPosition(string adresse)
        {
            ...
            var stringTask = client.GetAsync ("https://api.openrouteservice.org/geocode/search?api_key=5b3ce3597851110001cf62488cc5a239dfcc4cb480cb0a0acb208bd0&text="+adresse).Result;
